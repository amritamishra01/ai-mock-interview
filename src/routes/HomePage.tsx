...
export const HomePage = () => {
  ...
  <Marquee pauseOnHover>
    <MarqueImg img="/svg/img/logo/firebase.png" />
    <MarqueImg img="/svg/img/logo/meet.png" />
    <MarqueImg img="/svg/img/logo/zoom.png" />
    <MarqueImg img="/svg/img/logo/firebase.png" />
    <MarqueImg img="/svg/img/logo/microsoft.png" />
    <MarqueImg img="/svg/img/logo/meet.png" />
    <MarqueImg img="/svg/img/logo/tailwindcss.png" />
    <MarqueImg img="/svg/img/logo/microsoft.png" />
  </Marquee>
</div>
